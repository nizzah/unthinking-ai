    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16 animate-in fade-in duration-700">
      <div className="max-w-4xl w-full space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Primary step */}
          <Card className="bg-ocean-800/30 border-ocean-600 p-8 space-y-6 hover:bg-ocean-800/40 transition-colors">
            <div className="space-y-4">
              <p className="text-sm text-coral-400 uppercase tracking-wider">Recommended</p>
              <p className="text-xl text-white leading-relaxed">{primaryStep}</p>
            </div>
          ...
          {/* Smaller step */}
          <Card className="bg-ocean-800/20 border-ocean-700 p-8 space-y-6 hover:bg-ocean-800/30 transition-colors">
            <div className="space-y-4">
              <p className="text-sm text-stone-400 uppercase tracking-wider">Smaller step</p>
              <p className="text-xl text-stone-300 leading-relaxed">{smallerStep}</p>
            </div>
            <div className="space-y-3">
              <Button
